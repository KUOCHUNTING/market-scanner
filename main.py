...
# ✅ 強化版 fetch_stock_data（含三層 fallback）
def fetch_stock_data(symbol: str, client: SyncStocksClient) -> pd.DataFrame | None:
    """
    抓取 15 分 K 線，具備三層 fallback：
    1. 嘗試抓當天 15 分 K
    2. 若為空，改抓 1 分 K 並重採樣為 15 分
    3. 再空則抓昨天盤中 15 分 K
    """
    ...
    # === step 3: fallback - 改抓昨天 RTH 的 15 分 K
    if not bars:
