...
def get_fundamentals(symbol):
    try:
        ...
        fundamentals = {
            ...
            "market_cap": float(data.get("mktCap", 0)),
            "avg_volume": float(data.get("volAvg", 0)),
            "price": float(data.get("price", 0)),
            "is_otc": data.get("exchangeShortName", "") == "OTC",
