...
def calculate_indicators(df):
    ...
    # === 成交量資訊 ===
    curr_volume = indicators['curr_volume']
...
def detect_trading_signal(symbol, df, indicators):  # ✅ 有 symbol 參數
    ...
    if signal_type is None:
        ...
        # ✅ 加在這裡（用 indicators 的資料）
        volume_ratio = indicators['curr_volume'] / indicators['avg_volume'] if indicators['avg_volume'] > 0 else 1.0
