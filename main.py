...
def init_sheets():
    ...
    json_base64 = """"""
...
def check_abnormal_reversal_entry(symbol, df):
    try:
        ...
        is_vwap_near = latest_price >= latest_vwap * 0.98  # 尚未明顯跌破
    ...
    if (
        ...
        if symbol in observed_candidates:
            ...
            if price_diff <= 0.02 and time_diff <= 30:
                ...
                if check_30min_confluence(df_30m):
                    signal_note += "\n📌 技術共振：✅ 30M 共振"
                else:
                    signal_note += "\n📌 技術共振：⚠️ 無 30M 共振"
                    push_to_discord(symbol, signal_note)
    ...
    if (
        ...
        if symbol in observed_candidates:
            ...
            if price_diff <= 0.02 and time_diff <= 30:
                ...
                df_30m = fetch_30min_data(symbol)
                if check_30min_confluence(df_30m, direction="short"):
                    signal_note += "\n📈 技術共振：✅ 30M 共振"
                else:
                    signal_note += "\n📈 技術共振：⚠️ 無 30M 共振"
                    push_to_discord(symbol, signal_note)
...
def fetch_stock_data(symbol):
    ...
    try:
        ...
        candle_type = "陽線" if latest_close > latest_open else "陰線"
        direction = "多方" if latest_close > latest_open else "空方"

        print(f"[資訊] {symbol} K 線筆數：{len(df)}")
        print(f"[收盤] 最新收盤價：{latest_close:.2f}")
        print(f"[方向] 當前為：{direction}（{candle_type}）")
...
def analyze_stock_data(symbol, bars, tick_value, trin_value):
    try:
        ...
        if len(df) < 20 or 'close' not in df.columns or df['close'].isnull().all():
