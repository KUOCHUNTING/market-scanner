    ...
    for symbol in symbol_list:
        ...
        try:
            ...
            if signal_type:
                ...
                # ✅ 資金檢查與扣除
                # ✅ 進場前檢查是否已持倉
                if symbol in positions and positions[symbol]["direction"] == direction:
                    print(f"[略過] {symbol} 已持倉方向 {direction}，避免重複建倉")
                    continue
                ...
                if capital_left >= capital_used:
                    ...
                    print(f"[資金不足] 無法建倉 {symbol} ➜ 剩餘資金 ${capital_left:,.0f}，需要 ${capital_used:,.0f}")
