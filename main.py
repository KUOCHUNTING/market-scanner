...
# === 系統模組 ===
        write_to_sheet(symbol, direction, entry_price, latest_price, return_rate, holding_time, signal_type, tick_percentile, trin_value, tmo_value, tmo_slope, rsi_value, macd_status, vwap_deviation, volume_ratio)
