...
def detect_latent_signal(symbol, df, rsi, tmo, obv, latest_price, latest_vwap):
    ...
    # ✅ Debug log
    print(f"[DEBUG] 呼叫 detect_latent_signal 用參數：price={price:.2f}, vwap={vwap:.2f}")
    print(f"[DEBUG] 傳入參數：symbol={symbol}, price={price:.2f}, rsi={rsi_val:.2f}, tmo={tmo_val:.2f}, obv={obv_val:.2f}")
