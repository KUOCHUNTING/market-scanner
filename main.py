    ...
    for symbol in symbol_list:
        try:
            ...
            if signal_type:
                ...
                # ✅ 資金檢查與扣除
                if capital_left >= capital_per_trade:
                    capital_left -= capital_per_trade  # ✅ 扣除資金
                    ...
                    print(f"[資金不足] 無法建倉 {symbol} ➜ 剩餘資金 ${capital_left:,.0f}，需要 ${capital_per_trade:,.0f}")
        ...
        if (rsi > 60 or roc > 0.5 or ema5 > ema20 or obv_diff > 0):
           ...
           # === ✅ 策略比較與選擇
            ...
            if strategy_name == "順勢策略":
                ...
                direction = "多" if cond_rsi_long and cond_roc_long else "空"
            elif strategy_name == "均值回歸":
                direction = "多" if cond_zscore_low and cond_price_low else "空"
            else:
                direction = "無"  # 或 return 跳過本次，不建倉
